...
export abstract class BaseEntityModel implements BaseEntity {
   ...
   */
  protected validateEnumValue<T>(value: any, validValues: T[], fieldName: string): void {
   ...
   */
  protected generateAuditEvent(eventType: string, changes: any, entityType: string): any {
    return {
      id: uuidv4(),
      entityType,
      entityId: this.id,
